        ...
        <div class="flex gap-6 items-start max-w-7xl mx-auto">
            ...
            <div class="flex-1 min-w-0">
                <div class="nexus-card p-7">
                    ...
                    @if($users->isEmpty())
                        <p class="text-center text-cyan-300 opacity-60 py-10 text-sm">[ NO_ACTIVE_RECORDS_FOUND ]</p>
                    @else
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="text-white font-medium">
                                            ...
                                            @if($user->middle_name)
                                                <span class="text-xs text-cyan-300 block opacity-60">{{ $user->middle_name }}</span>
                                            @endif
                                        </td>
                                        <td>{{ $user->nickname ?? '—' }}</td>
                                        <td>{{ $user->email }}</td>
