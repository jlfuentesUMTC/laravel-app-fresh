<x-layout title="Edit User">
    ...
    <div class="nexus-body">
        <div class="nexus-card p-7">
            ...
            <p class="text-sm opacity-70 mb-6">Updating: {{ $user->first_name }} {{ $user->last_name }}</p>
            ...
            <form method="POST" action="{{ route('users.update', $user->id) }}">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <input class="form-input" type="number" name="age" value="{{ $user->age }}" placeholder="Age">
                    <input class="form-input" type="text" name="contact_number" value="{{ $user->contact_number }}" placeholder="Contact Number">
                </div>

                <textarea class="form-input" name="address" rows="2" placeholder="Address">{{ $user->address }}</textarea>
